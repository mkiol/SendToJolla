...
// Source: https://github.com/ATNoG/JSONObject/blob/nativeCpp/StringUtils.cpp
QString Utils::escapeJSON(const QString& input)
{
    QString output;
    output.reserve(input.length());

    for (QString::size_type i = 0; i < input.length(); ++i)
    {
