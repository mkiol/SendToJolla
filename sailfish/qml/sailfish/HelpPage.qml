    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Label {
                ...
                text: qsTr("In this mode, app acts as a local web server.")
                wrapMode: Text.WordWrap
            }
            ...
            Label {
                anchors {left: parent.left; right: parent.right; leftMargin: Theme.paddingLarge;rightMargin: Theme.paddingLarge}
                color: Theme.primaryColor
                text: qsTr("This mode is recommended for cases where your Jolla device and PC are in the same local network, so data can be transferred directly between these two devices.")
                wrapMode: Text.WordWrap
            }
